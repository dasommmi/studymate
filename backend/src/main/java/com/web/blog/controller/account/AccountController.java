...
public class AccountController {
    ...
    public Object kakaologin(@RequestParam("code") final String code) {
        ...
        if (userInfo.get("email") == null) {
            ...
            return new RedirectView("http://localhost:8081/#/duplicate");
        }
        ...
        // 따라서, DB에 그런 사람이 있는 지 없는지 카카오 메일과 이름으로 확인.
            ...
            if (userOpt != null) {
                ...
                String url = "http://localhost:8081/#/user/signup?email=" + user_email + "&nickname=" + namee + "&pass=" +
    ...
    public Object signup(@Valid @RequestBody final SignupRequest request) {
        ...
        if (email_test != null) {
            ...
            try {
                ...
                mail.setFrom("studymate@gmail.com", "스터디메이트");
